...
use super::super::{
    ...
    gatsby::GatsbyPlugin, graphql_codegen::GraphqlCodegenPlugin, husky::HuskyPlugin,
    ...
    oxlint::OxlintPlugin, parcel::ParcelPlugin, playwright::PlaywrightPlugin, plop::PlopPlugin,
    pm2::Pm2Plugin, postcss::PostCssPlugin, prettier::PrettierPlugin, prisma::PrismaPlugin,
